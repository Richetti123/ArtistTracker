...
export async function sendArtistEvidence(sock, artist, rawSendMessage) {
  ...
  await rawSendMessage(config.targetJid, { text: lines.join('\n') });
  ...
  for (const item of mediaCandidates) {
    ...
    try {
      ...
      const payload = item.type === 'image' ? { image: { url: localPath }, caption: `📎 Evidencia encontrada en ${item.network} para ${clean}.` } : { video: { url: localPath }, caption: `📎 Evidencia encontrada en ${item.network} para ${clean}.` };
      await rawSendMessage(config.targetJid, payload);
      attached++;
...
export async function sendTestMessage(sock, rawSendMessage) {
  console.log('\n╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮');
  console.log('┃ 🧪 PRUEBA DE ENVÍO DE ARTISTTRACKER        ┃');
  console.log('╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯');
  console.log('[TEST] Enviando mensaje simulado a WhatsApp...');
  ...
  await rawSendMessage(config.targetJid, { text: testText });
