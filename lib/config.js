...
export const config = {
  ...
  madridTerms: ['madrid','madrid, españa','madrid españa','comunidad de madrid','iberia madrid','barajas','t4 madrid','lavapiés','malasaña','gran vía','sol, madrid','chueca, madrid','retiro, madrid'],
  preferredGenres: ['reggaeton','pop','indie','rock','trap','bachata','dembow','musica criolla'],
  scan: { intervalMs: 30 * 60 * 1000, maxCandidatesPerCountry: 30, postsPerArtist: 12 },
  retentionDays: 7,
  apis: {
  ...
  listenerProviders: {
    // Prefer Songstats Enterprise when SONGSTATS_API_KEY is configured.
    // Zyla is a fallback that accepts the artist name directly.
